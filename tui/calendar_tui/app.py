...
from .screens import EventListScreen, LoginWaitScreen, SetupScreen, TimezoneScreen
...
class CalendarTUI(App):
    ...
    def _next_screen(self) -> SetupScreen | LoginWaitScreen | TimezoneScreen | EventListScreen:
        cfg = config.load()
